          ...
          ListView(
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: appText(text: 'Zoomax Birdy Plunk Foraging Bird toy'),
                    ),
                    SizedBox(
                      height: 20,
                    ),
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          width: 100,
                          child: appText(
                              text: index + 1, textAlignment: TextAlign.center),
                        ),
                      );
                    }),
              ),
              Container(
                margin: EdgeInsets.symmetric(horizontal: width * 0.060, vertical: 20),
              decoration: BoxDecoration(
              ...
              Container(
                ...
                width: width,
                margin: EdgeInsets.symmetric(horizontal: width * 0.060),
                child: appText(text: 'text',textAlignment: TextAlign.left,maxlines: 1000),
              ),
              SizedBox(
                height: 200,
              ),
           ...
           Positioned(
            ...
            child: Container(
              ...
              child: AppTextButton.appTextButton(
                ...
                text: 'Add to Cart', textFontWeight: FontWeight.w600,
